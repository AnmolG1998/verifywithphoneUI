...
import 'package:phoneverifyscreen/numeric_pad.dart';
import 'package:phoneverifyscreen/verify_phone.dart';
                ...
                children: <Widget>[
                  ...
                  Expanded(
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>VerifyPhone(phoneNumber: phoneNumber,)),);
                        },
                        child: Container(
                          decoration: BoxDecoration(
